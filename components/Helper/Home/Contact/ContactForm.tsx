...
const ContactForm = () => {
  ...
  return (
    <div className='bg-[#140c1c] rounded-lg p-4 sm:p-10 '>
      ...
      <p className='text-gray-200 mt-3 lg:text-base text-xs md:text-sm'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quasi fugit nesciunt ab. Excepturi, architecto velit!</p>
      {/* input fields */}
